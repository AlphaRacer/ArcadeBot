    ...
    execute(message, args) {
        if (args[0] === 'emojistatus') {
            ...
            const m = new Discord.MessageEmbed()
                ...
                .setDescription(
                    'The emojistatus command lets you to set an "emoji status". It\'s just like a normal status message, but with emoji (and text)'
                )
                .addField('Usage:', '`$emojistatus <arguments>`')
                .addField('Usable Arguments:', '`set`, `show`, `remove`')
                .addField(
                    '"set" argument',
                    'Use this to set an emoji status. Example: `$emojistatus set 😉`'
                )
                .addField(
                    '"show" argument',
                    "Use this to show your emoji status or see someone else's emoji status. Example: `$emojistatus show`. You can also see the emoji status of someone specific. Example: `$emojistatus show @AlphaRacer#3197`"
                )
                .addField(
                    '"remove" argument',
                    'You can remove your emoji status with this command. Example: `$emojistatus remove`'
                );
            ...
            const mmm = new Discord.MessageEmbed()
                ...
                .setDescription(
                    'Welcome a user by mentioning them or providing their ID'
                )
                .addField('Usage', '`$welcome <arguments>`')
                .addField('Usable arguments:', '`-id`')
                .addField(
                    '`-id` argument:',
                    'Use this to welcome a user with their id. Example: `$welcome -id 568066367518015506`'
                )
            ...
            const helpembed = new Discord.MessageEmbed()
                ...
                .addField(
                    '`$suggest`',
                    'Use this to suggest something for the server!'
                )
                .addField(
                    '`$welcome`',
                    'Welcome a user by mentioning them or providing their ID'
