					...
					db.set('messages', newMessage).then(() => {
						db.get('messages').then((value) => {
							if (value == 150) {
								...
								const Discord = require('discord.js');
								const links = ['https://media.discordapp.net/attachments/798422277661786162/810731228160327680/50_Card_-_Copy.png?width=849&height=425', 'https://media.discordapp.net/attachments/798422277661786162/810731232572866590/100_Card.png?width=849&height=425', 'https://media.discordapp.net/attachments/798422277661786162/810731232425672734/150_Card.png?width=849&height=425', 'https://media.discordapp.net/attachments/798422277661786162/810731648555155498/200_Card.png?width=849&height=425'];
								const x = ['a', 'b', 'c', 'd'];
								...
								const x = ['a', 'b', 'c', 'd'];
								// const Discord = require('discord.js');
								const links = ['https://media.discordapp.net/attachments/798422277661786162/811084260382867547/500_Crate.png?width=813&height=407', 'https://media.discordapp.net/attachments/798422277661786162/811084265365700658/1000_Crate.png?width=813&height=407', 'https://media.discordapp.net/attachments/798422277661786162/811084269551353906/1500_Crate.png?width=813&height=407', 'https://media.discordapp.net/attachments/798422277661786162/811084268280479794/2000_Crate.png?width=813&height=407'];
								switch(x[Math.floor(Math.random() * x.length)]) {
								case 'a':
									const e = new Discord.MessageEmbed()
										.setColor('#17a2b8')
